...
class BacktestWalkForwardRun(Base):
    __tablename__ = "backtest_walk_forward_runs"
    ...
    train_window_days: Mapped[int] = mapped_column(nullable=False)
    test_window_days: Mapped[int] = mapped_column(nullable=False)
    step_days: Mapped[int] = mapped_column(nullable=False)
    ...
    windows: Mapped[list["BacktestWalkForwardWindow"]] = relationship(back_populates="run")
